          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
            <div className="max-w-4xl mx-auto text-center">
              <p className="text-center">
                <span className="px-4 py-1 border border-green-700 bg-gradient-to-tr from-green-500 via-green-400 to-green-300 text-gray-100 rounded-xl">
                  Hassle-free Product sell
                </span>
              </p>
              ...
              <p className="mt-5 text-base text-white sm:text-xl">
                ...
                credit card, make your life simple.No more hassle taking loans
                and making payments. Try Postcrats credit card, make your life
                simple.
              </p>
